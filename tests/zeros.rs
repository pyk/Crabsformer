...
fn test_zeros_u8_one_dim() {
    let arr: Vec<u8> = Vec::one_dim().with_shape([2]).zeros().generate();
    assert_eq!(arr, [0, 0]);
}
...
fn test_zeros_u8_two_dim() {
    let arr: Vec<Vec<u8>> =
        Vec::two_dim().with_shape([1, 2]).zeros().generate();
    assert_eq!(arr, [[0, 0]]);
}
...
fn test_zeros_u8_three_dim() {
    let arr: Vec<Vec<Vec<u8>>> =
        Vec::three_dim().with_shape([1, 1, 2]).zeros().generate();
    assert_eq!(arr, [[[0, 0]]]);
}
...
fn test_zeros_u8_four_dim() {
    let arr: Vec<Vec<Vec<Vec<u8>>>> =
        Vec::four_dim().with_shape([1, 1, 1, 2]).zeros().generate();
    assert_eq!(arr, [[[[0, 0]]]]);
}

#[test]
fn test_zeros_u16_one_dim() {
    let arr: Vec<u16> = Vec::one_dim().with_shape([2]).zeros().generate();
    assert_eq!(arr, [0, 0]);
}
...
fn test_zeros_u32_one_dim() {
    let arr: Vec<u32> = Vec::one_dim().with_shape([2]).zeros().generate();
    assert_eq!(arr, [0, 0]);
}
...
fn test_zeros_u64_one_dim() {
    let arr: Vec<u64> = Vec::one_dim().with_shape([2]).zeros().generate();
    assert_eq!(arr, [0, 0]);
}
...
fn test_zeros_u128_one_dim() {
    let arr: Vec<u128> = Vec::one_dim().with_shape([2]).zeros().generate();
    assert_eq!(arr, [0, 0]);
}
...
fn test_zeros_i8_one_dim() {
    let arr: Vec<i8> = Vec::one_dim().with_shape([2]).zeros().generate();
    assert_eq!(arr, [0, 0]);
}
...
fn test_zeros_i16_one_dim() {
    let arr: Vec<i16> = Vec::one_dim().with_shape([2]).zeros().generate();
    assert_eq!(arr, [0, 0]);
}
...
fn test_zeros_i32_one_dim() {
    let arr: Vec<i32> = Vec::one_dim().with_shape([2]).zeros().generate();
    assert_eq!(arr, [0, 0]);
}
...
fn test_zeros_i64_one_dim() {
    let arr: Vec<i64> = Vec::one_dim().with_shape([2]).zeros().generate();
    assert_eq!(arr, [0, 0]);
}
...
fn test_zeros_i128_one_dim() {
    let arr: Vec<i128> = Vec::one_dim().with_shape([2]).zeros().generate();
    assert_eq!(arr, [0, 0]);
}
...
fn test_zeros_f32_one_dim() {
    let arr: Vec<f32> = Vec::one_dim().with_shape([2]).zeros().generate();
...
fn test_zeros_f64_one_dim() {
    let arr: Vec<f64> = Vec::one_dim().with_shape([2]).zeros().generate();
    assert_eq!(arr, [0.0, 0.0]);
}
